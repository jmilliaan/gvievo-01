...
NODE_API = {
    "get_logger", "get_parameter", "get_parameters", "declare_parameter", "get_clock",
    "create_publisher", "create_subscription", "create_service", "create_client",
    "create_timer", "create_rate", "destroy_node", "destroy_timer", "destroy_publisher",
    "destroy_subscription", "destroy_client", "destroy_service", "get_name", "get_namespace",
    "count_publishers", "count_subscribers", "executor", "context", "handle",
    "get_topic_names_and_types", "get_node_names", "set_parameters",
